    ...
    public function run(): void
    {
        $sections = [
            [
                ...
                'title_ar' => 'عن منتدى المهارات الإفريقية Africa Skills Forum',
                'title_fr' => 'À propos d\'Africa Skills Forum',
                'title_en' => 'About Africa Skills Forum',
                'body_ar' => 'منظومة منتدى المهارات الإفريقية تهدف إلى تعزيز التميز المهني والتكنولوجي والارتقاء بالكفاءات الإفريقية إلى المستويات الدولية من خلال بيئة تنافسية ومؤتمرات قياسية.',
                'body_fr' => 'Le système d\'Africa Skills Forum vise à promouvoir l\'excellence professionnelle et technologique et à élever les compétences africaines aux niveaux internationaux.',
                'body_en' => 'The Africa Skills Forum platform aims to promote professional and technological excellence and elevate African competencies to international levels.',
            ],
            [
