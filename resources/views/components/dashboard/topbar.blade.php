...
>
    ...
    <div class="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
        ...
        {{-- Official Dual Brand Logos (Ministry Seal + African Union) --}}
        <a href="{{ route('home') }}" class="flex items-center gap-2 group shrink-0" aria-label="{{ platform()->name() }}">
            <div class="flex items-center gap-2 bg-slate-50 dark:bg-slate-800 p-1 sm:p-1.5 px-2.5 sm:px-3.5 rounded-2xl border border-slate-200/80 dark:border-slate-700 shadow-xs overflow-hidden shrink-0 group-hover:scale-102 transition-transform">
