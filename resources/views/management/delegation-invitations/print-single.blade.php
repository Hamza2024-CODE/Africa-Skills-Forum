    ...
    <div class="a4-page flex flex-col justify-between border-4 border-[#06205C] p-8 bg-gradient-to-b from-white via-slate-50 to-amber-50/20 text-slate-900 relative">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between border-b-2 border-amber-400 pb-4">
                <img src="/ministry-logo.png" alt="وزارة التكوين والتعليم المهنيين" class="h-16 w-auto object-contain">
                ...
                <div class="text-center space-y-1">
                    ...
                    <h1 class="text-2xl font-black text-[#06205C] tracking-tight">AFRICA SKILLS POLICY FORUM 2026</h1>
                    <p class="text-xs font-bold text-amber-700">مركز المؤتمرات محمد بن أحمد — وهران، الجزائر</p>
                </div>

                <img src="/africa-logo-trimmed.png" alt="Africa Skills Forum" class="h-14 w-auto object-contain">
            </div>
