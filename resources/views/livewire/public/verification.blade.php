<div class="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 font-sans">
    ...
    @if($searched)
        @if(!$isAuthorizedScanner)
            <div class="p-8 bg-rose-50 border-2 border-rose-300 rounded-3xl text-center space-y-4 shadow-xl">
                <div class="w-16 h-16 rounded-full bg-rose-600 text-white font-black text-2xl flex items-center justify-center mx-auto shadow-lg">
                    🔒
                </div>
                <div class="space-y-1">
        ...
        @elseif($result)
            <!-- FULL ACCREDITED DOSSIER FOR AUTHORIZED SCANS -->
            @php
