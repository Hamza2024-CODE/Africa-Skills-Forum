@php
    ...
    $title = platform()->get("guide_title_{$locale}", $t('منتدى السياسات الأفريقية للمهارات 2026', 'Forum des Politiques Africaines des Compétences 2026', 'Africa Skills Policy Forum 2026', 'Fórum de Políticas Africanas de Competências 2026'));
    $subtitle = platform()->get("guide_subtitle_{$locale}", $t('صياغة مستقبل المهارات، تمكين الشباب الأفريقي — البوابة الرسمية للرؤية القارية والأهداف والمحاور الاستراتيجية', 'Façonner l\'avenir des compétences, autonomiser la jeunesse africaine — Portail officiel de la vision continentale.', 'Shaping the Future of Skills, Empowering Africa\'s Youth — Official portal for continental vision and strategic objectives.', 'Moldar o Futuro das Competências, Capacitar a Juventude Africana — Portal oficial da visão continental e objetivos estratégicos.'));
                ...
                <div class="lg:col-span-7 space-y-5">
                    ...
                    <div class="p-6 rounded-2xl bg-gradient-to-r from-emerald-50 via-slate-50 to-amber-50/50 border-s-4 border-[#35A536] border-y border-e border-slate-200 space-y-2 shadow-sm">
                        ...
                        <blockquote class="text-base sm:text-xl font-black text-[#0B2A6F] leading-snug italic">
                            "{{ $t('مستقبل المهارات في إفريقيا يجب أن يُصاغ من قِبل الأفارقة أنفسهم.', 'L\'avenir des compétences en Afrique doit être façonné par les Africains eux-mêmes.', 'Africa\'s skills future must be shaped by Africans.', 'O futuro das competências em África deve ser moldado pelos próprios africanos.') }}"
                        </blockquote>
                    </div>
