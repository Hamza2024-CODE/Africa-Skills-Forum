            ...
            <path fill="#052D48" d="M0,0 L1440,0 L1440,50 C1340,55 1160,10 960,35 C640,85 320,15 0,50 Z">
                <animate attributeName="d" dur="9s" repeatCount="indefinite"
                    values="M0,0 L1440,0 L1440,50 C1340,55 1160,10 960,35 C640,85 320,15 0,50 Z;
                            ...
                            M0,0 L1440,0 L1440,50 C1340,55 1160,10 960,35 C640,85 320,15 0,50 Z" />
            </path>

            <!-- Layer 2: Ambient Cyan Upper Glow -->
            <path fill="none" stroke="#24BDC3" stroke-width="4" stroke-opacity="0.35" d="M0,50 C320,15 640,85 960,35 C1160,10 1340,55 1440,50">
                <animate attributeName="d" dur="9s" repeatCount="indefinite"
