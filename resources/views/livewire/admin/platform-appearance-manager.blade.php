                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    ...
                    <div class="p-4 rounded-2xl bg-blue-50/70 border border-blue-200/80 space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" wire:click="toggleFacebookCard" {{ $facebook_card_enabled ? 'checked' : '' }} class="sr-only peer">
                    ...
                    <div class="p-4 rounded-2xl bg-red-50/70 border border-red-200/80 space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" wire:click="toggleYoutubeCard" {{ $youtube_card_enabled ? 'checked' : '' }} class="sr-only peer">
